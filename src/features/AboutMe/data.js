...
export const aboutMe = `Hi! Thanks for reading my resume!
    So, here's a little about me... I love solving problems! Whether it's about programming, logic games, or anything I have to put my mind to solve, I love it. And I'm stubborn when it comes to solving them, I can't stop until I figure out a solution. I love challenges!
    ...
    I'm also kinda lazy, but in a good way, 'cause I try all the time to find ways to automatize my work (hey, I even developed this resume in React so it's easier for me to update it's info! You can check out the source code in {GithubRepoLink})
